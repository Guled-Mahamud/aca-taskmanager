...
#module "network" {
  ...
  #appgateway_address_prefixes = var.appgateway_address_prefixes
...
#module "application_gateway" {
  ...
  #name             = "taskmanager-appgw"
  #location         = var.location
  #rg               = azurerm_resource_group.rg.name
  #appgateway_subnet_id = module.network.appgateway_subnet_id
  #cert_path        = "certs/certstaskmanager.pfx" 
  #cert_password    = var.cert_password
  #container_fqdn = module.container_app.fqdn
#}